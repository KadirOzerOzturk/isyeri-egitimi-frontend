...
function CommissionEditProfile() {
    ...
    const handleFormSubmit = (e) => {
        ...
        axios.put(`/commission/update/${user.komisyonId}`, changedUser)
             .then(response => {
                 ...
                 try {
                    const res =  axios.get(`/commission/${user.komisyonId}`);
                    if (res.status === 200) {
                      console.log("res" + res)
  ...
  return (
    <form  className="container mx-auto my-5 pl-24 pt-5 z-40  " >
                    ...
                    <div  className="mt-10 grid grid-cols-1  gap-y-8 ">
                        <div  className="grid grid-cols-3 w-full gap-12">
                            <div  className="flex items-center gap-2">
                                ...
                                <p  className="text-md  text-slate-600">{user.komisyonAd}</p>
                            </div>
                            <div  className="flex items-center gap-2">
                                <h1
                                    htmlFor="komisyonSoyad"
                                     className="block text-md font-medium leading-6 text-gray-900"
                                >
                                    Soyadı : 
                                </h1>
                                <p  className="text-md  text-slate-600">{user.komisyonSoyad }</p>
                            ...
                            <div  className="flex items-center gap-2">
                                ...
                                <input defaultValue={user.komisyonEposta} name="komisyonEposta" onChange={handleInputChange}  className="text-md  border-2 rounded-md p-1 text-slate-600" />
                            </div>
                        ...
                        <div  className="col-span-full">
                            ...
                            <div  className="mt-2">
                                <textarea
                                    id="komisyonHakkinda"
                                    name="komisyonHakkinda"
                                    rows={8}
                                    defaultValue={user.komisyonHakkinda}
                                    maxLength={1000}
            ...
            <div  className="mt-6 flex items-center justify-end gap-x-6">
                <button
                onClick={()=>navigate(`/commission-profile`)}
                    type="button"
...
export default CommissionEditProfile