...
<div className="bg-gray-200 w-full px-16 md:px-0 h-screen flex items-center justify-center font-roboto">
    <div className="bg-white border border-gray-200 flex flex-col items-center justify-center px-4 md:px-8 lg:px-24 py-8 rounded-lg shadow-2xl">
        ...
        <a href="#" className="flex items-center space-x-2 bg-blue-600 hover:bg-blue-700 text-gray-100 px-4 py-2 mt-6 rounded transition duration-150" title="Return Home">
            ...
            {userRole !== "STUDENT" ? <span onClick={() => navigate(`/${userRole.toLowerCase()}-profile`)}>Return Home</span> : <span onClick={() => navigate('/')}>Return Home</span>}
