...
export default function CompanyEditProfile() {
    const { user, userPhoto } = useSelector(state => state.auth);
        ...
        axios.put(`/company/update/${user.firmaId}`, changedUser)
            .then(response => {
                ...
                if (response.status == 200) {
                    ...
                    try {
                        const res = axios.get(`/company/${user.firmaId}`);
                        if (res.status === 200) {
                            console.log("res" + res)
    ...
    const uploadPhoto = (e) => {
        ...
        axios.post(`s3-bucket/upload/profilePhoto/company/${user.firmaId}`, formData, {
            headers: {
                    ...
                    <div className="mt-10 grid grid-cols-1  gap-y-8 ">
                        <div className="grid grid-cols-3 w-full gap-12">
                            <div className="flex items-center gap-2">
                                ...
                                <p className="text-sm  text-slate-600">{user.firmaAd}</p>
                            </div>
                            <div className="flex items-center gap-2">
                                <h1
                                    htmlFor="firmaSektor"
                                ...
                                <p className="text-sm  text-slate-600">{user.firmaSektor}</p>
                            ...
                            <div className="flex items-center gap-2">
                                ...
                                <input defaultValue={user.firmaEposta} name="firmaEposta" onChange={handleInputChange} className="text-sm  border-2 rounded-md p-1 text-slate-600" />
                            </div>
                        ...
                        <div className="col-span-full">
                            ...
                            <div className="mt-2">
                                <textarea
                                    ...
                                    name="firmaHakkinda"
                                    rows={8}
                                    defaultValue={user.firmaHakkinda}
                                    maxLength={1000}
